                              ...
                              <div class="row">
                                  <div class="col-md-3">
                                      ...
                                      <ul class="vertical-menu">
                                          <li><a href="#"><i class="ion-ios-circle-outline"></i> Mega menu is a new
                                                  feature</a></li>
                                          <li><a href="#"><i class="ion-ios-circle-outline"></i> This is an
                                                  example</a></li>
                                          <li><a href="#"><i class="ion-ios-circle-outline"></i> For a submenu
                                                  item</a></li>
                                          <li><a href="#"><i class="ion-ios-circle-outline"></i> You can add</a></li>
                                          <li><a href="#"><i class="ion-ios-circle-outline"></i> Your own items</a>
                                          </li>
                                      </ul>
                                  </div>
                                  <div class="col-md-9">
                                      ...
                                      <div class="row">
                                          <article class="article col-md-4 mini">
                                              <div class="inner">
                                                  <figure>
                                                      <a href="single.html">
                                                          <img src="Public/asset/images/news/img10.jpg"
                                                              alt="Sample Article">
                                                      </a>
                                                  </figure>
                                                  <div class="padding">
                                          ...
                                          <article class="article col-md-4 mini">
                                              <div class="inner">
                                                  <figure>
                                                      <a href="single.html">
                                                          <img src="Public/asset/images/news/img11.jpg"
                                                              alt="Sample Article">
                                                      </a>
                                                  </figure>
                                                  <div class="padding">
                                          ...
                                          <article class="article col-md-4 mini">
                                              <div class="inner">
                                                  <figure>
                                                      <a href="single.html">
                                                          <img src="Public/asset/images/news/img14.jpg"
                                                              alt="Sample Article">
                                                      </a>
                                                  </figure>
                                                  <div class="padding">
